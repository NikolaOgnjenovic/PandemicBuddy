...
public class NotificationSender {
    ...
    private final String CHANNEL_ID = "PandemicBuddy";
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "PandemicBuddy"; //Име канала
            String description = "Pandemic Buddy notification channel"; //Опис канала
