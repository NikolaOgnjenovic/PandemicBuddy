package com.app.pandemicbuddy.location.service;
...
import com.app.pandemicbuddy.LanguageManager;
import com.app.pandemicbuddy.NotificationSender;
import com.app.pandemicbuddy.R;
import com.app.pandemicbuddy.Settings;
...
public class Tracker extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent nIntent = new Intent(context, Settings.class); //Упали екран са подешавањима када се стисне нотификација
        ...
        finder.setOnUpdateEvent(location -> {
            notifyUser(location);
